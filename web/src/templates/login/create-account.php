...
<form action="?command=create_account" method="post" class="m-4">
    <div class="row mb-3">
    ...
    <div class="d-flex justify-content-center mt-4">
        <button type="submit" class="btn btn-success ms-2" style="min-width:100px; font-size:x-large;">Create Account</button>
    </div>
</form>
