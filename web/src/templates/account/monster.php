<div class="row my-2" id="monsterContainer<?php echo $MONSTER[0]; ?>">
  ...
  <div class="col-sm-6 text-sm-start">
    <a class="btn btn-secondary" href="/sem9bd/monster-api.php?command=view&monster_id=<?php echo $MONSTER[0]; ?>" target="_blank" aria-label="View <?php echo $MONSTER[1]; ?> JSON">JSON</a>
    ...
    <a class="btn btn-warning" href="/sem9bd/monster-editor.php?monster_id=<?php echo $MONSTER[0]; ?>" aria-label="Edit <?php echo $MONSTER[1]; ?>">Edit</a>
