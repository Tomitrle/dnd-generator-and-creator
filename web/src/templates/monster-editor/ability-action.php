<div class="col-sm-6 col-lg-4" onclick="deleteSelf(event, this)">
  <div class="row mb-1">
    <label class="form-label" for="<?php echo $CATEGORY; ?>Name<?php echo $UNIQUE_ID; ?>">Name</label>
    <div class="col-10">
      <input id="<?php echo $CATEGORY; ?>Name<?php echo $UNIQUE_ID; ?>" name="<?php echo $CATEGORY; ?>Name<?php echo $UNIQUE_ID; ?>" class="form-control" type="text" pattern="[\w\s]+" aria-required="true" required>
    </div>
