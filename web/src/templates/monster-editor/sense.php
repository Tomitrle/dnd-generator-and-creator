<div class="row mb-1"onclick="deleteSelf(event, this)">
  ...
  <input type="hidden" class="form-control" id="sense<?php echo $UNIQUE_ID; ?>" value="Sense">
  <div class="col-6 d-flex align-items-center text-wrap text-break">
    Sense Type
  </div>
  <div class="col-5 text-wrap text-break">
    <input type="number" min="0" step="5" class="form-control" id="senseRange<?php echo $UNIQUE_ID; ?>" placeholder="0 ft" aria-required="true" required>
  </div>
