<div class="row mb-1" onclick="deleteSelf(event, this)">
  ...
  <div class="col-5 text-wrap text-break">
    <input id="senseName<?php echo $UNIQUE_ID; ?>" name="sense[name][]" type="hidden">
    <input id="senseRange<?php echo $UNIQUE_ID; ?>" name="sense[range][]" class="form-control" type="number" min="0" max="1000" step="5" placeholder="0 ft" aria-required="true" required>
  </div>
