<div class="row mb-1">
  ...
  <div class="   col-8   col-sm-5">
    <input id="<?php echo $CATEGORY; ?>Score" name="<?php echo $CATEGORY; ?>_score" class="form-control text-center" type="number" min="1" max="30" value="10" aria-required="true" required>
  </div>

  <input id="<?php echo $CATEGORY; ?>Modifier" name="<?php echo $CATEGORY; ?>_modifier" type="hidden" value="0">
  ...
  <div class="d-flex   mb-3   col-sm-4 mb-sm-0 align-items-sm-center justify-content-sm-center">
    <div class="form-check mt-1">
      <input id="<?php echo $CATEGORY; ?>SavingThrow" name="<?php echo $CATEGORY; ?>_saving_throw" class="form-check-input" type="checkbox" aria-label="Saving Throw">
