<div class="row mb-1">
  ...
  <div class="   col-8   col-sm-5">
    <input id="<?php echo $CATEGORY; ?>Score" name="<?php echo $CATEGORY; ?>_score" class="form-control text-center" type="number" min="1" max="30" value="<?php echo (isset($MONSTER[$CATEGORY . "_score"])) ? $MONSTER[$CATEGORY . "_score"] : "10"; ?>" aria-required="true" required>
  </div>
