<div class="col-sm-6 col-lg-4" onclick="deleteSelf(event, this)">
  <div class="row mb-1">
    ...
    <div class="col-10">
      <input id="<?php echo $CATEGORY . "Name" . $UNIQUE_ID; ?>" name="<?php echo $CATEGORY; ?>[name][]" class="form-control" type="text" pattern="[\w\s]+" aria-required="true" required>
    </div>
  ...
  <textarea id="<?php echo $CATEGORY . "Description" . $UNIQUE_ID; ?>" name="<?php echo $CATEGORY; ?>[description][]" class="form-control" rows="4" aria-required="true" required></textarea>
  ...
  <input id="<?php echo $CATEGORY . "Benefit" . $UNIQUE_ID; ?>" name="<?php echo $CATEGORY; ?>[benefit][]" class="form-range" type="range" min="-1" max="2" value="0" oninput="updateSliderLabel(event)">
</div>
<?php $UNIQUE_ID += 1; ?>